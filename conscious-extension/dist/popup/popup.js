...
async function loadTodaySummary() {
    try {
        const sessions = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__.getTodaySessions)();
        let totalSeconds = 0;
        let activeSeconds = 0;
        ...
        if (totalTimeElement)
            totalTimeElement.textContent = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.formatTime)(totalSeconds);
        if (activeTimeElement)
            activeTimeElement.textContent = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.formatTime)(activeSeconds);
    }
    catch (err) {
...
function updateCurrentSessionDisplay() {
    if (timerElement)
        timerElement.textContent = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.formatTime)(currentSessionData.totalSecs);
    if (statusElement) {
    ...
    if (domainElement)
        domainElement.textContent = currentSessionData.domain || 'No active session';
}
